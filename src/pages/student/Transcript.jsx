      ...
      <div ref={ref} className="bg-white rounded-2xl shadow-soft border border-ink-100 p-10 max-w-4xl mx-auto">
        ...
        <div className="flex items-start justify-between pb-6 border-b-2 border-ink-900">
          ...
          <div className="text-right text-xs text-ink-500">
            <div className="font-semibold text-ink-900 text-base">SIARM University</div>
            <div>BP 3000, Bonaberi · Douala, Cameroon</div>
            <div>www.siarm.edu</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-12 gap-y-2 mt-8 text-sm">
          ...
          <div><span className="text-ink-500">Document ID:</span> <span className="font-mono text-xs">SIARM-{Date.now().toString(36).toUpperCase()}</span></div>
        </div>
        ...
        {/* Signature */}
        <div className="mt-12 pt-6 border-t border-ink-200 grid grid-cols-2 gap-12">
          <div>
            <div className="h-12" />
        ...
        <div className="mt-8 text-[10px] text-ink-400 text-center flex items-center justify-center gap-1.5">
          <FileText size={10} /> Generated by SIARM · Verify authenticity at verify.siarm.edu
        </div>
      </div>
    </div>
  )
