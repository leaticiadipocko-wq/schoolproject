  ...
  return (
    <div className="space-y-6">
      ...
      <div ref={printRef} className="bg-white border border-ink-100 rounded-2xl p-8 print-section">
        ...
        {/* Footer */}
        <div className="mt-8 pt-6 border-t border-ink-200 grid grid-cols-2 gap-12 text-xs text-ink-600">
          <div>
            <div className="h-10" />
        ...
        <div className="mt-4 text-[9px] text-ink-400 text-center">
          Generated by SIARM · IUGET Bonabéri · Verify at verify.iuget.cm
        </div>
      </div>
