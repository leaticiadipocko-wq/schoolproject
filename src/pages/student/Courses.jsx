...
import { MOCK_COURSES, MOCK_RECOMMENDED_COURSES } from '@/lib/mockData'
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Smart course suggestions based on your performance"
      />
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          {MOCK_RECOMMENDED_COURSES.map((c) => (
            <div key={c.code} className="p-4 rounded-xl bg-white border border-brand-100">
              ...
              <button className="btn-secondary w-full mt-3 text-xs py-2">Enroll</button>
            </div>
          ))}
        </div>
      </div>
