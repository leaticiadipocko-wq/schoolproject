...
export function LanguageProvider({ children }) {
  ...
  const LANG_LABELS = { en: 'Français', fr: 'English', pcm: 'French', fub: 'Français' }
...
export const TRANSLATIONS = {
  en: {
    ...
    'common.lang.toggle':    'Français / Pidgin / Fulfulde',
  ...
  fr: {
    ...
    'common.lang.toggle':    'English / Pidgin / Fulfulde',
  ...
  pcm: {
    ...
    'common.back':           'Go back',
    'common.save':           'Save am',
    'common.search':         'Searsh…',
    'common.welcome':        'Welcome',
    'common.dashboard':      'Dashboad',
    'common.profile':        'Profile',
    'common.settings':       'Settings',
    'common.help':           'Help',
    'common.notifications':  'Notifications',
    'common.noNotifications':'No notif',
    'common.markAllRead':    'Mak all read',
    'common.theme.light':    'Light theme',
    'common.theme.dark':     'Dark theme',
    'common.lang.toggle':    'French',
    'common.required':       'We need am',
    'common.optional':       'If you like',
    'nav.attendance':        'Atendens',
    'nav.timetable':         'Timetable',
    'nav.results':           'Resolt',
    ...
    'nav.learning':          'Mobile Learnin',
    'nav.classes':           'My Klas',
    'nav.markAttendance':    'Mark Atendens',
    'nav.enterGrades':       'Put Grades',
    'nav.users':             'Users',
    'nav.enrolment':         'Enrolment',
    'nav.finance':           'Money Tracin',
    'nav.analytics':         'Analytics',
    'login.title':           'Sign in',
    'login.subtitle':        'Enter your dashboad.',
    'login.email':           'Email address',
    'login.password':        'Passwod',
    'login.rememberMe':      'Remember me',
    'login.forgot':          'I 4get passwod?',
    'login.signing':         'De sign in…',
    'login.success':         'Welcome back, {name}!',
    'login.error.empty':     'Fill all di boxes',
    'login.welcomeBack':     'Welcome back to',
    'login.tagline':         'akademic excelens.',
    'student.greeting':      'Welcome back, {name}',
    'student.balance':       'Money wey you dey owe',
    'student.balanceDue':    'Due {date}',
    'student.idcard':        'Student ID Card',
    'student.idcard.view':   'Look am & print',
    'student.idcard.valid':  'Good till Sep 2027',
    'student.stats.attendance':'Atendens wey remain',
    'student.stats.gpa':     'GPA wey you get',
    'student.stats.courses': 'Kourses wey dey',
    'student.stats.classesToday':'Klas today',
    'student.attendanceTitle':'Atendens per kourse',
    'student.thisSemester':  'Dis semester',
    'student.todayTitle':    'Today',
    'student.todayEmpty':    'No klas today — enjoy!',
    'student.latestAnnouncements':'Latest tins',
    'student.myCourses':     'My Kourses',
    'footer.copyright':      '© {year} SIARM · Bachelor projekt — IUGET Bonabéri',
    'footer.author':         'By James Murdza · Level 3 SWE',
  },

  fub: {
    'common.signIn':         'Naatuu',
    'common.signOut':        'Wurtu',
    'common.getStarted':     'Fuɗɗo',
    'common.continue':       'Jokku',
    'common.cancel':         'Accu',
    'common.back':           'Rutto',
    'common.save':           'Danndu',
    'common.search':         'ɗaɓɓu…',
    'common.welcome':        'Mabbu',
    'common.dashboard':      'Dashboard',
    'common.profile':        'Profayl',
    'common.settings':       'Settings',
    'common.help':           'Ballal',
    'common.notifications':  'Kumpite',
    'common.noNotifications':'Alaa kumpite',
    'common.markAllRead':    'Maak fof tar',
    'common.theme.light':    'Annoora',
    'common.theme.dark':     'Nyaluma',
    'common.lang.toggle':    'Français',
    'common.required':       'Haaɗa',
    'common.optional':       'Si a yidii',
    'nav.attendance':        'Darorde',
    'nav.timetable':         'Jamaanu',
    'nav.results':           'Njeñtudi',
    'nav.announcements':     'Kumpite',
    'nav.idcard':            'Kartol ID',
    'nav.fees':              'Pese jangirde',
    'nav.transcript':        'Sertifikat',
    'nav.learning':          'Koygol mobiil',
    'nav.classes':           'Klasji am',
    'nav.markAttendance':    'Winndu darorde',
    'nav.enterGrades':       'Naattu njeñtudi',
    'nav.users':             'Jawɓe',
    'nav.enrolment':         'Winnditaare',
    'nav.finance':           'Njayri jokkindirgol',
    'nav.analytics':         'Analytics',
    'login.title':           'Naatuu',
    'login.subtitle':        'Yahu to dashboard maa.',
    'login.email':           'Adres iimeel',
    'login.password':        'Passwod',
    'login.rememberMe':      'Janto kam',
    'login.forgot':          'Passwod maa yejjitaa?',
    'login.signing':         'Naatude…',
    'login.success':         'Mabbu, {name}!',
    'login.error.empty':     'Tiiɗa hebbin dennda',
    'login.welcomeBack':     'Mabbu to',
    'login.tagline':         'mawnuki jannde.',
    'student.greeting':      'Mabbu, {name}',
    'student.balance':       'Pese ngu piyaa',
    'student.balanceDue':    'Haala {date}',
    'student.idcard':        'Kartol ID janngoowo',
    'student.idcard.view':   'Yiyu & tappu',
    'student.idcard.valid':  'Huuwoo haa Sep 2027',
    'student.stats.attendance':'Darorde hakkiinde',
    'student.stats.gpa':     'GPA jooni',
    'student.stats.courses': 'Kursuuji golaaɗi',
    'student.stats.classesToday':'Klasji hannde',
    'student.attendanceTitle':'Darorde per kurse',
    'student.thisSemester':  'Semester ndee',
    'student.todayTitle':    'Hannde',
    'student.todayEmpty':    'Alaa klas — ndaara naange!',
    'student.latestAnnouncements':'Kumpite kesi',
    'student.myCourses':     'Kursuuji am',
    'footer.copyright':      '© {year} SIARM · Projet bachelor — IUGET Bonabéri',
    'footer.author':         'James Murdza · Level 3 SWE',
  },
}
