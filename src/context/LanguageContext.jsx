...
export const TRANSLATIONS = {
  en: {
    ...
    'parent.hero.subtitle':  'IUGET Bonabéri — the Institut Universitaire des Grandes Écoles des Tropiques — offers three accredited specialties combining theory, practical projects, and direct industry entry. Everything a parent needs to register their child is on this page.',
  ...
  fr: {
    ...
    'parent.hero.subtitle':  'IUGET Bonabéri — l\'Institut Universitaire des Grandes Écoles des Tropiques — propose trois spécialités accréditées alliant théorie, projets pratiques et insertion professionnelle directe. Toutes les informations nécessaires à l\'inscription se trouvent sur cette page.',
